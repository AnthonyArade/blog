                ...
                <div class="p-6 text-gray-900">
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                        <div class="flex items-center justify-between">
                            ...
                            <p>Vous avez rediger {{ $articles->count() }} Articles ! </p>
                        </div>
                            ...
                            <tbody>
                                @foreach ($articles as $article)
                                    <tr
                                        ...
                                        <th scope="row"
                                            class="px-6 py-4 mb-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            {{ $article->title }}
                                        </th>
                                        ...
                                        <td class="px-6 py-4 mb-4">
                                            <a href="{{ route('show', $article->id) }}">
                                                <button class="text-green-600 mr-4 hover:text-green-900">
                                                    <i class="fas fa-eye"></i>Voir
                                                </button>
                                            </a>
                                            <a href="{{ route('edit.blog', $article) }}"
                                                ...
                                                <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                                    <div
                                                        ...
                                                        <div class="flex justify-center items-center space-x-4">
                                                            ...
                                                            <form action="{{ route('delete.blog', $article) }}"
                                                                method="post">
                                                                @csrf
                                                                @method('delete')
                                                                <button type="submit"

        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    @if ($editMode == 1)
                    <form action="{{ route('update.blog',$article[0]->id) }}" method="post">
                        @method('PUT')
                    @else
                    ...
                    <div class="mb-6">
                        ...
                        <input name="title" id="title"
                            ...
                            placeholder="Un titre magnifique" value="{{ @$article[0]->title }}" required />
                    </div>
                    <div
                        ...
                        <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                            <label for="editor" class="sr-only">Publier</label>
                            <textarea id="editor" name="content" rows="8"
                                class="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400"
                                placeholder="Votre merveilleux article" required>{{ @$article[0]->content }}</textarea>
                        </div>
                    </div>
                    <button type="submit"
